  ...
  return (
    <Page>
      <Panel>
        ...
        <div>{text.items[0].caption}{text.items[0].text}</div>
        <div>{text.items[1].caption}{text.items[1].text}</div>
        <div>{text.items[2].caption}{text.items[2].text}</div>
        <div>{text.items[3].caption}{text.items[3].text}</div>
